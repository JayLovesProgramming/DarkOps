...
namespace Gizmo
{
    ...
    {
        return _degrees * (DARKOPS_PI / 180.0f); // Use a util pre-made function instead of creating a new one that includes duplicated code
    }
